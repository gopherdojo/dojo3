...
func TestJpegToPng(t *testing.T) {
	...
	runner := &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Jpeg{}, Encoder: &conversion.Png{}, Force: true, Verbose: true}
	runner.Run(tmpdir)
...
func TestJpegToGif(t *testing.T) {
	...
	runner := &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Jpeg{}, Encoder: &conversion.Gif{}, Force: true, Verbose: true}
	runner.Run(tmpdir)
...
func TestPngToJpeg(t *testing.T) {
	...
	runner := &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Png{}, Encoder: &conversion.Jpeg{}, Force: true, Verbose: true}
	runner.Run(tmpdir)
...
func TestPngToGif(t *testing.T) {
	...
	runner := &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Png{}, Encoder: &conversion.Gif{}, Force: true, Verbose: true}
	runner.Run(tmpdir)
...
func TestGifToJpeg(t *testing.T) {
	...
	runner := &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Gif{}, Encoder: &conversion.Jpeg{}, Force: true, Verbose: true}
	runner.Run(tmpdir)
...
func TestGifToPng(t *testing.T) {
	...
	runner := &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Gif{}, Encoder: &conversion.Png{}, Force: true, Verbose: true}
	runner.Run(tmpdir)
...
func TestConflict(t *testing.T) {
	...
	runner = &Runner{OutStream: buf, ErrStream: buf, Decoder: &conversion.Jpeg{}, Encoder: &conversion.Png{}, Force: false, Verbose: true}
